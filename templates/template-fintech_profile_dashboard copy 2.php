              ...
              <div class="dashboard-page-body">
                <div class="dashboard-page-header">
                  ...
                  <div class="dashboard-page-sections">
                    <div class="dashboard-section" id="dashboard-overview-sections">
                      <div class="dashboard-left">
                        <div class="dashboard-item">
                          <div class="bolt-icon">
                            <svg width="16" height="22" viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M5.97778 13.0889L5.26667 20.2L14.5111 10.2444L9.53333 7.4L10.2444 1L1 10.9556L5.97778 13.0889Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                          </div>
