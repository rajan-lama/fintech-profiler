...
if (!empty($_GET['fintech'])) {
  ...
  $fintech_pricing_plan_link = get_post_meta($fintech_id, 'pricing_plan_link', true);
  $fintech_pricing_plan_description = get_post_meta($fintech_id, 'pricing_plan_description', true);
