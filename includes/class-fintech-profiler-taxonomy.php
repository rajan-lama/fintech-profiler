...
if ( ! class_exists( 'Fintech_Profiler_Taxonomy' ) ) {
    ...
    class Fintech_Profiler_Taxonomy {
        ...
        public function register_taxonomy() {
            ...
            register_taxonomy( 'fintech-category', array( 'fintech' ), $args );
            ...
            register_taxonomy( 'fintech-size', array( 'fintech' ), $args );
            ...
            register_taxonomy( 'fintech-pricing', array( 'fintech' ), $args );
